"""
Django settings for hdis_bill_management project.
...
GET_SERVICE_BY_ID_URL = f"http://host.docker.internal:8016/api/v1/services/{{}}/"
GET_PRICE_BY_SERVICE_ID_URL = f"http://host.docker.internal:8016/api/v1/service-prices/{{}}/"
GET_TAX_BY_SERVICE_ID_URL = f"http://host.docker.internal:8016/api/v1/service-taxes/{{}}/"
GET_DISCOUNT_BY_SERVICE_ID_URL = f"http://host.docker.internal:8016/api/v1/service-discounts/{{}}/"
...
ROOT_URLCONF = 'hdis_bill_management.urls'
...
WSGI_APPLICATION = 'hdis_bill_management.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'bill_management_admin',
        'PASSWORD': 'bill_management_admin_password',
        'HOST': 'db',
        'PORT': '3306',
    }
}
