...
channel.queue_bind(queue='hdis_consultation_plan', exchange='hdis_facility')
channel.queue_bind(queue='hdis_consultation_plan', exchange='hdis_doctor_administration')
channel.queue_bind(queue='hdis_consultation_plan', exchange='hdis_patient_registration')
channel.queue_bind(queue='hdis_consultation_plan', exchange='hdis_appointment_management')
channel.queue_bind(queue='hdis_consultation_plan', exchange='hdis_visit_management')
