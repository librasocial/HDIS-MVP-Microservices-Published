...
ROOT_URLCONF = 'hdis_employee_management.urls'
...
WSGI_APPLICATION = 'hdis_employee_management.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'employee_management_admin',
