...
class Billing(models.Model):
    ...
    providerId = models.ManyToManyField('visit_management.Provider', related_name='bills')
...
class Episode(models.Model):
    ...
    facilityId = models.ForeignKey(Facility, on_delete=models.CASCADE)
    patientId = models.ForeignKey(Patient, on_delete=models.CASCADE)
    providerId = models.ManyToManyField('visit_management.Provider', related_name='episode')
