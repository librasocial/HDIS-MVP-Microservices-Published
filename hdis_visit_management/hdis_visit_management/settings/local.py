"""
Django settings for hdis_visit_management project.
...
ALLOWED_HOSTS = ['visit.openhdis.com','docker.for.mac.localhost']
...
ROOT_URLCONF = 'hdis_visit_management.urls'
...
WSGI_APPLICATION = 'hdis_visit_management.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'visit_management_admin',
        'PASSWORD': 'visit_management_password',
        'HOST': 'db',
        'PORT': '3306',
    }
}
