...
ROOT_URLCONF = 'hdis_queue_management.urls'
...
WSGI_APPLICATION = 'hdis_queue_management.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'queue_management_admin',
        'PASSWORD': 'queue_management_password',
        'HOST': 'db',
        'PORT': '3306',
    }
}
