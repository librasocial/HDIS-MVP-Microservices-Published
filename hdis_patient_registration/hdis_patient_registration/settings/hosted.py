"""
Django settings for hdis_patient_registration project.
...
ALLOWED_HOSTS = ['patreg.openhdis.com','docker.for.mac.localhost']
...
ROOT_URLCONF = 'hdis_patient_registration.urls'
...
WSGI_APPLICATION = 'hdis_patient_registration.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'patient_register_main',
        'USER': 'patient_register_main_admin',
        'PASSWORD': 'patient_admin_password',
        'HOST': 'db',
        'PORT': '3306',
    }
}
