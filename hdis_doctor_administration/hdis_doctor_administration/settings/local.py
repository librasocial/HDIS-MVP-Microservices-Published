"""
Django settings for hdis_doctor_administration project.
...
ALLOWED_HOSTS = ['docadmin.openhdis.com','docker.for.mac.localhost']
...
ROOT_URLCONF = 'hdis_doctor_administration.urls'
...
WSGI_APPLICATION = 'hdis_doctor_administration.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'doctor_administration',
        'USER': 'doctor_administration_admin',
        'PASSWORD': 'doctor_administration_password',
        'HOST': 'db',
        'PORT': '3306',
    }
}
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'doctorDocuments')
MEDIA_URL = '/doctorDocuments/' 
